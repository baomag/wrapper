...
#adata = scv.read("/storage/singlecell/maggie/ABCA4/seurath52merge/reannotated_samples_merged.h5ad")
...
#
cell_cycle_genes = ["MKI67", "CCNA2", "MSX1", "MSX2", "CD274", "RB1", "CCNB1", "CCND1", "JUN", "CDK11B"]
...
#plt.savefig("/storage/singlecell/maggie/ABCA4/seurath52gene_module/overall_umap_by_selected_cell_cycle_score.png",
