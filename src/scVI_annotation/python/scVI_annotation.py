...
# load reference
adata_ref = sc.read("/storage/singlecell/zz4/fetal_bash/results/merged_h5ad/merged_raw_filtered_umap_10000_major_sub_class.h5ad")
print(adata_ref)
...
adata_query = sc.read("/storage/singlecell/maggie/multi/seurath52merge/merged_normalized_merged.h5ad")
...
adata_full.write("/storage/singlecell/maggie/multi/scVI_annotation/merged_normalized_merged_annotated.h5ad")
adata_query.obs.to_csv("/storage/singlecell/maggie/multi/scVI_annotation/scVI_annotation/merged_normalized_merged_annotated.csv")
